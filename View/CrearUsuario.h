...
namespace ProyectoPoo20261 {
	...
	/// <summary>
	/// Summary for CrearUsuario
	/// </summary>
	public ref class CrearUsuario : public System::Windows::Forms::Form
	{
	public:
		CrearUsuario(System::Windows::Forms::Form^ p)
		{
			InitializeComponent();
			FormularioLogin = p;
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(CrearUsuario::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &CrearUsuario::button1_Click);
			// 
			// textBox1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		Usuario^ NewUser = Controller::Operations::CreateUser(textBox1->Text, textBox2->Text);	
		MessageBox::Show("Usuario " + NewUser->Nombre + " creado exitosamente");
